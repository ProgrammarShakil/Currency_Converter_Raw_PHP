        ...
        <div class="card bg mt-3 text-dark p-3 text-center">
                ...
                <div class="col-md-12">
                    <div>
                        ...
                        <img height="100px" width="100px" style="border-radius: 50%; border:4px solid #ccc" src="../images/profile.jpg" alt="">
                        <h4 class="pt-3">User</h4> <hr>
                        <div>
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="" method="post">
                                    <h4 class="p-3 bg-dark mb-2 text-light" style="border-radius: 3px;">Change Name / Email</h4>
                                <div class="mb-3">
                                    <label for="usrname" class="form-label">Name *</label>
                                    <input name="usrname" value="" type="text" class="form-control" id="usrname" >
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Email *</label>
                                    <input name="email_update" value="" type="email" class="form-control" id="">
                                </div>
                                <button name="update_email" type="submit" class="btn btn-dark btn-block">Save</button>
                                </form>
                            </div>
...
if (isset($_REQUEST['update_email'])){
    ...
    $email_update = mysqli_real_escape_string($connection,$_REQUEST['email_update']);

    if ( $usrname && $email_update) {
       
    $query2 = " UPDATE userlogin SET username = '$usrname', email = '$email_update' WHERE user_id = '{$_SESSION['user_id']}' ";
                        ...
                        <div class="col-md-6">   
                            ...
                            <div class="card bg mt-3 text-dark p-3 text-start">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="" method="post">
                                                <h4 class="p-3 bg-dark mb-2 text-light" style="border-radius: 3px;">Change Pasword</h4>
                                            <div class="mb-3">
                                            ...
                                            <button name="pass_update" type="submit" class="btn btn-dark btn-block">Save</button>
                                            </form>
                                        </div>
